...
class ApiUserMessages {
  ...
  static const String connectionError = 'Unable to connect to server. Please check your connection.';
  
  // Authentication Errors
  static const String invalidCredentials = 'The email or password you entered is incorrect.';
  static const String unauthorized = 'Your session has expired. Please log in again.';
  static const String forbidden = 'You don\'t have permission to access this resource.';
  
  // Server Errors
  static const String internalServerError = 'Something went wrong on our end. We\'re working on it!';
  static const String serviceUnavailable = 'Service is temporarily unavailable. Please try again later.';
  
  // Client Errors
  static const String notFound = 'The requested resource was not found.';
  static const String badRequest = 'There was an issue with your request. Please check your input.';
  
  // Business Logic
  static const String emailAlreadyExists = 'An account with this email already exists.';
  static const String accountLocked = 'Your account has been temporarily locked. Please try again later.';
  static const String validationFailed = 'Please check your information and try again.';
